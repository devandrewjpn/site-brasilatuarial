                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-12">
                                                                <div className="tp-hero__thumb mb-20">
                                                                    <img style={{width: "auto", height: "auto"}} className="w-100" src={hero_thumb_1} alt="theme-pure" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            {hero_thumbs.map((item, i) =>
                                                                <div key={i} className={`col-md-${item.col}`}>
                                                                    <div className={`tp-hero__thumb ${item.cls}`}>
                                                                        <img style={{width: "auto", height: "auto"}} className="w-100" src={item.img} alt="theme-pure" />
                                                                    </div>
                                                                </div>
                                                            )}
                                                        </div>
                                                ...
                                                <div className="col-md-4">
                                                    <div className="tp-hero__thumb-box">
                                                        <div className="tp-hero__thumb">
                                                            <img style={{width: "auto", height: "auto"}} className="w-100" src={hero_thumb_2} alt="theme-pure" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
