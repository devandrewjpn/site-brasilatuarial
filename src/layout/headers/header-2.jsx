                     ...
                     <div className="row g-0 align-items-center">
                        <div className="col-xl-2 col-lg-2 col-md-6 col-6">
                           <div className="tp-header-2__logo">
                              <Link className="white-logo" href="/"><img width={150} src="/atuarial/assets/img/logo-branca.svg" alt="theme-pure" /></Link>
                              <Link className="black-logo" href="/"><img width={150} src="/atuarial/assets/img/logo.png" alt="theme-pure" /></Link>
                           </div>
                        </div>
