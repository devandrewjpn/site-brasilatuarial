      ...
      <>
         ...
         <div className="about-banner-area p-relative">
            <div className="about-shape-1 z-index-3">
               <img src="/atuarial/assets/img/breadcrumb/breadcrumb-shape-1.png" alt="theme-pure" />
            </div>
            <div className="about-shape-2 z-index-3">
               <img src="/atuarial/assets/img/breadcrumb/breadcrumb-shape-2.png" alt="theme-pure" />
            </div>
